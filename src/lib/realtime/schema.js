...
export function normalizeSession(session) {
  ...
  return sanitizeSession({
    ...
    salonDate: typeof session.salonDate === 'string' ? session.salonDate : '',
    groupChatUrl: typeof session.groupChatUrl === 'string' ? session.groupChatUrl : '',
    joinSalonId: typeof session.joinSalonId === 'string' ? session.joinSalonId : '',
