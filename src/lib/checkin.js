...
export function normalizeCheckinApplication(application, index = 0) {
  ...
  return {
    ...
    joinParticipantId: String(application.joinParticipantId || '').trim(),
    joinCheckinStatus: String(application.joinCheckinStatus || '').trim(),
    joinNotificationStatus: String(application.joinNotificationStatus || '').trim(),
    joinNotificationError: String(application.joinNotificationError || '').trim(),
...
export function createCheckinApplicationFromJoinPass(pass = {}) {
  ...
  return normalizeCheckinApplication({
    ...
    joinParticipantId: pass.joinParticipantId || '',
    joinCheckinStatus: pass.joinCheckinStatus || '',
    joinNotificationStatus: pass.joinNotificationStatus || '',
    joinNotificationError: pass.joinNotificationError || '',
